...
- To mention a Feishu user when the envelope only gives a user ID, include `<mention user_id="ou_...">Name</mention>` in the message body; Anima sends it as a Feishu rich-text mention.
