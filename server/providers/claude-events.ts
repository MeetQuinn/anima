...
import {
  ...
  claudeSubagentModelFromContents,
  claudeSubagentResultsFromClaudeJson,
  claudeSubagentsDir,
  claudeSubagentTextKey,
  claudeTranscriptPath,
  hasSubagentLinkage,
  parseClaudeJsonlLine,
  readClaudeSubagentMetadata,
  subagentActivityLinkageFromClaudeJson,
  updateClaudeJsonlContext,
  type ClaudeJsonlMapperState,
