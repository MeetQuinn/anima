...
- **A team that works together, not a single assistant.** You build a team of agents, each with its own
  name, role, and expertise. They split work by role, hand off in Slack, and pull in the right person or
...
- **You own it, and it runs on your machine.** Anima is open source: there's no Anima cloud, no account with us, and nothing phones home. Your team's
  ...
  under your own account. You decide what the team works on, and you review its work.
