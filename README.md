...
Anima is not another model. It is the local teammate runtime around Claude Code, Codex, Kimi CLI, Grok Build, and OpenCode: identity, message routing, durable context, team memory, and an audited boundary for acting in Slack.
...
- Claude Code, Codex, Kimi CLI, Grok Build, or OpenCode installed and signed in.
...
Anima on one machine you control
        ...
        v
Claude Code, Codex, Kimi CLI, Grok Build, or OpenCode
...
You should. Claude Code, Codex, Kimi, Grok Build, and OpenCode provide the intelligence and developer tools Anima builds on.
...
| **Coding agents**  | Claude Code, Codex, Kimi CLI, Grok Build, OpenCode |
| **Host**           | macOS or Linux                                     |
