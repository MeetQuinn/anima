...
import TokenUsagePage, { commonCoverageStart, formatShare, rankAgents } from './TokenUsagePage';
...
// The former dialog-focus contract (Close focus, Tab wrap, return focus) went
// with the portal: this is now a routed page inside the settings shell, and
// the shell's own tests pin page-switch focus. Nothing here may claim modal
// behaviour anymore.
