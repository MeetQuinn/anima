...
export const queryKeys = {
  ...
  kbDirectory: (id: string, path: string) => ['kb-directory', id, path] as const,
  kbSearch: (id: string, query: string) => ['kb-search', id, query] as const,
  ...
  providerLogin: () => ['provider-login'] as const,
